      ...
      <div className='dashboard-body'>
        <div className='dashboard-body-top'>
          ...
          <div className='dashboard-body-top-right'>
            ...
            />
            <OptionCard title={t('dashboard.scr-input')} bgColor='#4C4E8D' icon={SCR_INPUT_ICON} />
          </div>
        </div>
        ...
        <div className='mt-5' style={{ position: 'relative' }}>
          ...
          <div className='alerts-wrapper'>
            <Alert message='Maintien des valeurs a la date initale de calibrage' type='success' />
            <Alert
